...
spark.sql("CREATE TABLE workforce_raw.wd_employee(employee_id integer,user_name string,first_name string,middle_name string,last_name string,preferred_name_first_name string,preferred_name_middle_name string,preferred_name_last_name string,gender strung,Date_Of_Birth date,phone_number string,home_phone_number string,Emergency_Contact_Name string,Emergency_Contact_Number_Home string,Emergency_Contact_Number_Work string,primary_work_email string,location string,Address_Line string,location_address_City string,location_address_State string,location_address_country string,Postal_Code string,Time_Zone string,location_reference_id string,position_id integer,position_title string,previous_system_id string,is_manager string,hire_date timestamp,original_hire_date timestamp,job_classification_id string,job_code string,job_family string,job_family_group string,active_status string,contract_end_date timestamp,Status string,manager_employee_id integer,Supervisor string,supervisory_org_name string,supervisory_organization_id string,Supervisor_location_hierarchies string,cost_center_id string,cost_centre string,cost_center_name string,contingent_worker_supplier string,time_type string,worker_type string,worker_sub_type string,load_datetime timestamp,file_name string,datepart date) USING delta PARTITIONED BY(datepart) LOCATION '"+emp_raw+"/Workday/employee_wd_raw'");
...
spark.sql("CREATE TABLE workforce_stage.stg_employee_consolidated(employee_id integer,first_name string,middle_name string,last_name string,preferred_first_name string,preferred_middle_name string,preferred_last_name string,user_name string,gender string,Date_Of_Birth date,phone_number string,home_phone_number string,office_address string,Emergency_Contact_Name string,Emergency_Contact_Number_Home string,Emergency_Contact_Number_Work string,email_work string,primary_work_email string,location string,location_code string,location_address_City string,location_address_State string,location_address_country string,Postal_Code string,Time_Zone string,location_reference_id string,drop_code string,affiliate string,hub string,position_id integer,position_title string,previous_system_id string,domain string,is_manager string,hire_date timestamp,original_hire_date timestamp,job_title string,job_classification_id string,job_code string,job_family string,job_family_group string,active_status string,contract_end_date timestamp,Status string,supplier string,secondary_vendor string,manager_employee_id integer,Supervisor string,supervisory_org_name string,supervisory_organization_id string,Supervisor_location_hierarchies string,time_type string,worker_type string,cost_center_id string,cost_centre string,cost_center_name string,worker_sub_type string,contingent_worker_supplier string,currently_active string,retiree string,rsa_unique_personel_id string,rsa_email_work string,active_ind string,load_datetime timestamp,datepart date)  USING delta PARTITIONED BY(datepart) LOCATION '"+emp_stage+"/stg_employee_consolidated'");
...
val lakePath = "abfss://edna-workforcedatadomain@bdaze1iednadl01.dfs.core.windows.net/Raw/"
spark.sql("CREATE TABLE workforce_curated.employee_consolidated(employee_id integer,first_name string,middle_name string,last_name string,preferred_first_name string,preferred_middle_name string,preferred_last_name string,user_name string,gender string,Date_Of_Birth date,phone_number string,home_phone_number string,office_address string,Emergency_Contact_Name string,Emergency_Contact_Number_Home string,Emergency_Contact_Number_Work string,email_work string,primary_work_email string,location string,location_code string,location_address_City string,location_address_State string,location_address_country string,Postal_Code string,Time_Zone string,location_reference_id string,drop_code string,affiliate string,hub string,position_id integer,position_title string,previous_system_id string,domain string,is_manager string,hire_date timestamp,original_hire_date timestamp,job_title string,job_classification_id string,job_code string,job_family string,job_family_group string,active_status string,contract_end_date timestamp,Status string,supplier string,secondary_vendor string,manager_employee_id integer,Supervisor string,supervisory_org_name string,supervisory_organization_id string,Supervisor_location_hierarchies string,time_type string,worker_type string,cost_center_id string,cost_centre string,cost_center_name string,worker_sub_type string,contingent_worker_supplier string,currently_active string,retiree string,rsa_unique_personel_id string,rsa_email_work string,active_ind string,Effective_Startdate timestamp,Effective_Enddate timestamp,load_datetime timestamp,datepart date ) USING delta PARTITIONED BY(datepart) LOCATION '"+emp_consolidatedpath+"'");